...
slide.addShape(pres.shapes.LINE, {
    ...
    line: { color: colors.line, width: 2.5, arrowTypeEnd: 'triangle', arrowSizeEnd: 8 }
});
slide.addShape(pres.shapes.LINE, {
...
slide.addShape(pres.shapes.LINE, {
    ...
    line: { color: colors.line, width: 2.5, arrowTypeEnd: 'triangle', arrowSizeEnd: 7 }
});
slide.addShape(pres.shapes.LINE, {
    x: 1.2, y: mainY + 1.75, w: 0.25, h: 0,
    line: { color: colors.line, width: 2.5, arrowTypeBegin: 'triangle', arrowSizeBegin: 7 }
});
...
// 保存到新文件
const outputPath = "/root/.openclaw/workspace/港口物流服务供应链_v2.pptx";
